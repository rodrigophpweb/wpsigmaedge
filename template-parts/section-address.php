...
$address = sigma_edge_get_address_data();
?>
<section class="section-address">
    <?php if ($address['map_embed']) : ?>
        <div class="section-address__map">
            <?php echo $address['map_embed']; ?>
        </div>
    <?php else : ?>
        <div class="section-address__map">
            <iframe
    ...
    <div class="section-address__content">
        <header class="section-address__header">
            ...
            <div class="section-address__heading">
                <h2 class="section-address__title"><?php echo esc_html($address['title']); ?></h2>

                <?php if ($address['subtitle']) : ?>
                    <span class="section-address__subtitle"><?php echo esc_html($address['subtitle']); ?></span>
                <?php endif; ?>
            </div>
        </header>
        ...
        <form class="contact-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
            ...
            <div class="contact-form__group">
                <label for="contact-phone">Contato (DDD) xxxx-xxxx</label>
                <input
                    type="tel"
                    id="contact-phone"
                    name="contact_phone"
            ...
            <div class="contact-form__group">
                <label for="contact-message">Seu recado</label>
                <textarea
                    id="contact-message"
